...
const purposeOptions = [
  ...
  {
    value: "first_draft",
    label: "To generate a first draft or outline for my assignment",
  },
  {
    value: "improve_grammar",
    label: "To improve or rephrase my writing for grammar, clarity, or tone",
  },
  {
    value: "explore_ideas",
    label: "To explore different perspectives or approaches to the topic",
  },
  {
    value: "summarize",
    label: "To help summarize or better understand complex readings or topics",
  },
  {
    value: "create_media",
    label:
      "To create or improve images, graphics, or other media for the assignment",
  },
  { value: "coding_help", label: "To help with coding or debugging tasks" },
  {
    value: "citation_help",
    label: "To generate citations or help with reference formatting",
  },
  {
    value: "translation",
    label:
      "To translate content or improve fluency in English or another language",
  },
  {
    value: "study_guides",
    label: "To create practice questions or study guides",
  },
  {
    value: "specialized_gpt",
    label:
      "To use a specialized GPT or AI assistant designed for a specific task",
  },
...
export default function StudentAITransparencyForm() {
  ...
  const handleSignatureChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prev) => ({
      ...
      signatureTimestamp: value ? formattedTimestamp : "",
    }));
  };
  ...
  const addAITool = () => {
    setFormData((prev) => ({
      ...
      aiTools: [
        ...prev.aiTools,
        { toolName: "", aiType: "", purpose: [], settings: "" },
      ],
    }));
  ...
  const validateForm = () => {
    ...
    const assignmentInfoValid =
      !!formData.assignmentTitle &&
      !!formData.courseCode &&
      !!formData.instructorName;

    // Check if at least one AI tool is properly filled
    const aiToolsDetailsValid = formData.aiTools.map(
      (tool) => !!tool.toolName && !!tool.aiType && tool.purpose.length > 0
    );

    // Check if at least one AI tool is valid
    const atLeastOneAiToolValid = aiToolsDetailsValid.some(
      (isValid) => isValid
    );

    // Check digital signature
    const signatureValid =
      !!formData.digitalSignature && formData.signatureConfirmation;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateForm()) {
      ...
      if (errors.studentInfo) {
        ...
        document
          .querySelector(".ai-tools-section")
          ?.scrollIntoView({ behavior: "smooth" });
      } else if (errors.signature) {
        document
          .getElementById("digitalSignature")
          ?.scrollIntoView({ behavior: "smooth" });
      }
      return;
    }
        ...
        <CardHeader className="bg-gradient-to-r from-blue-50 to-white pb-6 border-b">
          <div className="flex items-center gap-4">
            ...
            <div>
              <CardTitle
                id="form-title"
                className="text-2xl font-bold text-[#0055A2]"
              >
                SAID — Student AI Disclosure
              </CardTitle>
              <p className="text-gray-600 mt-3">
                Document your use of AI tools for academic assignments
              </p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="pt-8 px-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-800">
                      This tool empowers you to transparently document your use
                      of AI tools in academic assignments. The{" "}
                      <span className="font-bold">easy-to-use</span> templates
                      and prompts guide you in disclosing how, when, and why AI
                      was utilized, ensuring alignment with your instructor’s
                      guidelines and institutional policies. Customize your
                      disclosure with checkboxes, text fields, and optional
                      reflections to clarify your process. Refer to{" "}
                      <a
                        href="https://docs.google.com/document/d/1XjSmMeGR98jHjyTyl4XawSxEgAQDPaDHKY-WP5f6QKw/edit?usp=sharing"
                        className="text-blue-600 hover:underline"
                      >
                        the SAID Guide
                      </a>{" "}
                      for tips on ethical AI use and best practices.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3
                    ...
                    className="text-lg font-semibold text-[#0055A2]"
                  >
                    Student Information
                  </h3>
                </div>
                ...
                >
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      aria-required="true"
                      aria-invalid={
                        errors.studentInfo && formSubmitted ? "true" : "false"
                      }
              ...
              <div className="space-y-6 ai-tools-section">
                {errors.aiTools && formSubmitted && (
                  <Alert className="mb-4 border-red-400 bg-red-50">
                    ...
                    <AlertDescription className="text-red-600">
                      Please add at least one AI tool with all required fields
                      filled.
                    </AlertDescription>
                  </Alert>
                )}
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Label className="text-lg font-semibold text-[#0055A2]">
                    AI Tools Used
                  </Label>
                </div>
                ...
                {formData.aiTools.map((tool, index) => (
                  <div
                    ...
                    className={`p-6 border ${
                      errors.aiToolsDetails[index] && formSubmitted
                        ? "border-red-400"
                        : "border-[#E5E7EB]"
                    } rounded-lg space-y-5 bg-white shadow-md hover:shadow-lg transition-all`}
                  >
                    <div className="flex justify-between items-center border-b border-[#E5E7EB] pb-3 mb-2">
                      <h3 className="font-medium text-[#0055A2]">{`AI Tool ${
                        index + 1
                      }`}</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        ...
                        <Select
                          value={tool.toolName}
                          onValueChange={(value) =>
                            handleAIToolChange(index, "toolName", value)
                          }
                          required
                        >
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          value={tool.aiType}
                          onValueChange={(value) =>
                            handleAIToolChange(index, "aiType", value)
                          }
                          required
                        >
                          <SelectTrigger className="w-full border-[#939597] focus:border-[#0055A2] focus:ring-[#0055A2] h-10 rounded-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        <Label className="font-medium">
                          What were you trying to achieve with AI use? (Select
                          all that apply){" "}
                        ...
                        <DropdownChecklist
                          ...
                          onChange={(values) =>
                            handlePurposeChange(index, values)
                          }
                      ...
                      <div className="space-y-2">
                        <Label className="font-medium">
                          Custom Settings/Chat history Links{" "}
              ...
              <div className="mb-6">
                {errors.signature && formSubmitted && (
                  <Alert className="mb-4 border-red-400 bg-red-50">
                    <AlertCircle className="h-4 w-4 text-red-600" />
                    <AlertTitle className="text-red-600">
                      Signature Required
                    ...
                    <AlertDescription className="text-red-600">
                      Please provide your digital signature and confirmation.
                    </AlertDescription>
                  </Alert>
                )}
                <div className="flex items-center gap-2 mb-4">
                  <svg
                    ...
                    strokeLinejoin="round"
                  >
                    <path d="M3 17.5c.2-1.8 2.2-3.3 4.2-3.3 1.4 0 2.6.6 3.3 1.5.7-.9 1.9-1.5 3.3-1.5 2 0 4 1.5 4.2 3.3"></path>
                ...
                <div className="bg-white p-5 rounded-lg border border-[#E5E7EB] shadow-sm">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="digitalSignature" className="font-medium">
                      ...
                      <Input
                        ...
                        aria-required="true"
                        aria-invalid={
                          errors.signature && formSubmitted ? "true" : "false"
                        }
                        className="border-[#939597] focus:border-[#0055A2] focus:ring-[#0055A2] h-10 rounded-md"
                      />
                    </div>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-green-800">
                            Digitally signed on {formData.signatureTimestamp}
                          </span>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="flex items-start gap-3 mt-4">
                      ...
                      />
                      <Label
                        htmlFor="signatureConfirmation"
                        className="text-sm leading-relaxed"
                      >
                        I confirm that this is my digital signature and that all
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-[#0055A2] font-semibold text-base mb-3">
                      Declaration
                    </h4>
                    <div className="flex items-start gap-3 mt-2">
                      ...
                      <Label
                        ...
                        className="text-sm leading-relaxed"
                      >
                        I confirm that all AI tools listed above were used
                        ethically and in compliance with San Jose State
                        University's academic integrity policy. I understand
                        that this declaration will be included with my
                        submission.
                      </Label>
                    </div>
                  </div>
              ...
              <Button
                ...
                disabled={
                  !formData.declaration || !formData.signatureConfirmation
                }
              >
              ...
              <div className="mt-6 bg-gray-100 p-4 rounded-lg border border-gray-200">
                <p className="text-gray-700 mb-3">
                  Help us improve the SAID by reporting any issues you
                  encounter.
                </p>
                <Button
                  variant="outline"
                  ...
                  onClick={() =>
                    window.open("https://forms.gle/7SvKBwvkXfNo4UMh9", "_blank")
                  }
                >
                  Report an issue
                </Button>
